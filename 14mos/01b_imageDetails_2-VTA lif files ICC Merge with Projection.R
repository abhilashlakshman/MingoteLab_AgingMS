...
setwd("~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/12 mos_age/2-VTA lif files ICC Merge with Projection/output/")
file.ls <- list.files()
...
write.table(out.dat, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/12 mos_age/Analysed/imageDetails_2-VTA lif files.txt",
