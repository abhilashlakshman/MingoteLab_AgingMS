...
setwd("~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/24 mos_age/1-VTA_counted tifs/output_image/")
file.ls <- list.files()
...
write.table(out.dat, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/24 mos_age/Analysed/imageDetails_1-VTA_counted.txt",
