...
setwd("~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/3 mos_age/3-VTA czi files ICC Merge with Projection/output/")
file.ls <- list.files()
...
write.table(out.dat, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/3 mos_age/Analysed/imageDetails_3-VTA czi files.txt",
