...
saveRDS(out.ls.da, "DA_3mos.rds")
saveRDS(out.ls.daglu, "DAGLU_3mos.rds")

# # EXPORT THESE VALUES TO A TAB DELIMITED TEXT FILE
# write.table(max.mat.da, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/HeatmapData/forStats/DA_maxDistCenter_3mos.txt", row.names = T, col.names = NA, sep = "\t", quote = F)
# write.table(max.mat.daglu, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/HeatmapData/forStats/DAGLU_maxDistCenter_3mos.txt", row.names = T, col.names = NA, sep = "\t", quote = F)
# write.table(mean.mat.da, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/HeatmapData/forStats/DA_meanDistCenter_3mos.txt", row.names = T, col.names = NA, sep = "\t", quote = F)
# write.table(mean.mat.daglu, "~/OneDrive - Indiana University/ShaferLab/Others/Jackie/INTRSECT Ant.-Post._Medial-Lateral/Medial-Lateral/HeatmapData/forStats/DAGLU_meanDistCenter_3mos.txt", row.names = T, col.names = NA, sep = "\t", quote = F)
